...
Vygenerováno dne 2026-09-07 ze složky běhu `ucs/uc04_matchmaker/eval/runs/2026-09-07-data-facts-425-customers-population/` (databáze `substrate.db`, sha256 aba47a161d87…). Bez volání jazykového modelu.
...
| `sanity_seconds` | 6.7 | training + scoring time of the sanity check |

Zdrojová data: `attachments/uc04-data-facts.csv`.
