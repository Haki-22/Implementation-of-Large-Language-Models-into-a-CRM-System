...
Model: claude claude-sonnet-5 (low); NER bardsai; unify none
Task: Shrň následující zprávu ze CRM do tří vět. Drž věcný tón, nic nevymýšlej.
Ran: 2026-09-05 19:50, 3 min 34 s

## claude claude-sonnet-5

    20 of 20 echoed the envelope id on the first attempt       (the correlation wrapper the model must copy back)
    20 of 20 kept every token on the first attempt             (no placeholder dropped or invented)
    20 attempts for 20 messages                                (mean 1.0; retries carry a reminder)
...
claude (claude-sonnet-5, low) kept the envelope contract on the first attempt for 20 of 20 messages, 20 of 20 came back restored, and 68 of 68 original values reappeared in the restored text.
