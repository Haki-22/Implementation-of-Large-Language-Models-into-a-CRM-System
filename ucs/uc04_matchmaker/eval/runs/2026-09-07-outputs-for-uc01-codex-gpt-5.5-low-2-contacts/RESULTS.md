# UC-04 outputs for UC-01 — 2026-09-07-outputs-for-uc01-codex-gpt-5.5-low-2-contacts
...
Provider / model / tier: codex / gpt-5.5 / low (CLI codex-cli 0.152.1)
Prompts: version 1.0.0, Czech; reasons cite purchase ids, aspects quote verbatim
When: 2026-09-07, 20 s, 10 model calls
...
## Recommendation reasons (ALS top-k + one Czech sentence each)
    ...
    20.5 words median, 21 max                          (the rule says at most 30)
    8.1 s median per call                              (the call itself)
