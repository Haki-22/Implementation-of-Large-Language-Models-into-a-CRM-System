# UC-04 outputs for UC-01 — 2026-09-07-outputs-for-uc01-claude-claude-haiku-4-5-low-2-contacts
...
Provider / model / tier: claude / claude-haiku-4-5 / low (CLI 2.1.263 (Claude Code))
Prompts: version 1.0.0, Czech; reasons cite purchase ids, aspects quote verbatim
When: 2026-09-07, 2 min 29 s, 10 model calls
...
## Recommendation reasons (ALS top-k + one Czech sentence each)
    ...
    14.5 words median, 17 max                          (the rule says at most 30)
    43.1 s median per call                             (the call itself)
